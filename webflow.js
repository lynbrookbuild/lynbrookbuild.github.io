...
Webflow.require('ix').init([
  {"slug":"header-appear","name":"Header Appear","value":{"style":{},"triggers":[{"type":"scroll","selector":".small-header","offsetBot":"15%","stepsA":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"-60px"}],"stepsB":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"0px"}]}]}},
  {"slug":"hidden-section-dissapear","name":"Hidden Section Dissapear","value":{"style":{},"triggers":[{"type":"load","stepsA":[{"display":"none","height":"0px","transition":"height 500ms ease 0ms"}],"stepsB":[]}]}},
  {"slug":"hiring-section-appear","name":"Hiring Section Appear","value":{"style":{},"triggers":[{"type":"click","selector":".hidden-hiring-section","stepsA":[{"display":"block"},{"height":"auto","transition":"height 500ms ease 0ms"}],"stepsB":[{"height":"0px","transition":"height 500ms ease 0ms"},{"display":"none"}]}]}},
  {"slug":"hidden-form-appear","name":"Hidden Form Appear","value":{"style":{},"triggers":[{"type":"click","selector":".hidden-form","stepsA":[{"display":"block"},{"height":"auto","transition":"height 500ms ease 0ms"}],"stepsB":[{"height":"0px","transition":"height 500ms ease 0ms"},{"display":"none"}]},{"type":"click","selector":".hidden-section","stepsA":[{"height":"0px","transition":"height 500ms ease 0ms"},{"display":"none"}],"stepsB":[]}]}}
]);
